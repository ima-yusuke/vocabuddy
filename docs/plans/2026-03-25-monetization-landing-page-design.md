...
- **カラー**: メインカラー1色 + サブカラー1色 + グレー系（白黒ベース）
- **スタイル**: ミニマルで落ち着いた雰囲気を維持しつつ、訴求力を持たせる
- **レスポンシブ**: モバイルファーストで設計
...
- 4つのプラン（Free/Standard/Plus/Premium）をカード形式で横並び
- 各プランの単語数制限、月額・年額料金を明示
