...
<div class="side_wrapper w-full">
    <div class="side_menu_off pt-8 px-6">
        <div class="mb-8">
            ...
            <div class="h-0.5 w-12 bg-[#ffeb54] rounded-full"></div>
        </div>
        ...
        <div class="py-4 overflow-y-auto">
            <ul class="space-y-3">
                ...
                @else
                    ...
                    <li class="side_li">
                        <a href="{{ route('ShowReplyHistory') }}" class="flex items-center px-4 py-3 text-white hover:bg-white/10 rounded-xl transition-all duration-300 group">
                            <svg class="w-5 h-5 mr-3 text-[#ffeb54] group-hover:text-[#ffeb54]/80 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg font-semibold">返信履歴</span>
                        </a>
                    </li>
                    <li class="side_li">
